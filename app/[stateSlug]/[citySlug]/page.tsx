...
export async function generateMetadata({
  ...
  const title = `Funeral Homes in ${cityName}, ${stateName} | Funeral Home Directories`;
  const description = `Find trusted funeral homes and mortuaries in ${cityName}, ${stateName}—browse ${count.toLocaleString()} verified listings with contact details, maps, and Google ratings so you can choose with confidence.`;
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${cityName}, ${stateName} funeral home directory preview`,
        },
      ],
    },
  };
...
export default async function CityPage({ params }: CityPageProps) {
  ...
  const webpageSchema = {
    ...
    about: [
      {
        "@type": "Thing",
        name: `${cityName} funeral homes`,
      },
      {
        "@type": "Thing",
        name: `${stateName} funeral home listings`,
      },
      ...funeralCategorySchemaThings(),
    ],
    speakable: {
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <header className="space-y-4">
        ...
        <p className="max-w-2xl text-sm text-slate-600">
          {cityName} has {facilities.length.toLocaleString()} verified funeral home
        ...
        <p className="max-w-2xl text-sm text-slate-600">
          ...
          and find the right funeral home for your family in{" "}
          {stateName}.
        </p>
      </header>
      ...
      <section className="mt-8 space-y-4">
        ...
        {facilities.length === 0 ? (
          <p className="text-sm text-slate-600">
            We don&apos;t have funeral homes listed for {cityName}, {stateName} yet.
